...
\title{Topologie Algébrique} % 代数拓扑
...
\logo{../../TexTemplate/fig/logo.png} % 这里放置封面logo，默认从figure目录下寻找
...
\input{chapters/chap01.tex} % 基本群
\input{chapters/chap02.tex} % 平面分割定理
\input{chapters/chap03.tex} % Chapter 3
% --- Part 2 同调论 ---
\part{Homology Theory}
\input{chapters/chap04.tex} % Chapter 4
\input{chapters/chap05.tex} % Chapter 5
\input{chapters/chap06.tex} % Chapter 6
% --- Part 3 上同调论 ---
\part{Cohomology Theory}
% \input{chapters/chap07.tex} % Chapter 7
% \input{chapters/chap08.tex} % Chapter 8
% \input{chapters/chap09.tex} % Chapter 9



\appendix
\part{Appendix} % 附录部分
\chapter{Glossary} % 术语索引
\section*{J} % 以字母 J 开头的术语
\begin{itemize}
    \item \textbf{Jordan Curve (Jordan 曲线)}:~\ref{def:jordan_curve} 
    \item 
\end{itemize}


\section*{S} % 以字母 S 开头的术语
\begin{itemize}
    \item \textbf{Simple Closed Curve (简单闭曲线)}:~\ref{def:jordan_curve}
    \item \textbf{Simply Connected Space (单连通空间)}:~\ref{def:simply_connected_space}
\end{itemize}

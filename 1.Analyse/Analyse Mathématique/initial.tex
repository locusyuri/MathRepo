...
\begin{table}[h]
    ...
    \begin{tabular}{ccp{12cm}}
        ...
        1.0 & January, 2026 & Basic content completed, including chapters on limits and continuity, 
            differentiation and integration (including multivariate), series, curve theory, line and surface integrals, 
            and parameter-dependent integrals. \\
        \bottomrule
    \end{tabular}
\end{table}
...
\part{Appendix}
\chapter{Glossary}
\section*{A} % 以字母 A 开头的术语
\begin{itemize}
    \item \textbf{(Real) Analytic Function (实解析函数)}:~\ref{def:real_analytic_function}
\end{itemize}
\section*{B} % 以字母 B 开头的术语
\section*{C} % 以字母 C 开头的术语
\section*{D} % 以字母 D 开头的术语
\section*{E} % 以字母 E 开头的术语
\section*{F} % 以字母 F 开头的术语
\section*{G} % 以字母 G 开头的术语
\section*{H} % 以字母 H 开头的术语
\section*{I} % 以字母 I 开头的术语
\section*{J} % 以字母 J 开头的术语
\section*{K} % 以字母 K 开头的术语
\section*{L} % 以字母 L 开头的术语
\section*{M} % 以字母 M 开头的术语
\section*{N} % 以字母 N 开头的术语
\section*{O} % 以字母 O 开头的术语
\section*{P} % 以字母 P 开头的术语
\section*{Q} % 以字母 Q 开头的术语

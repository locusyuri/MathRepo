...
\begin{definition}{Equinumerosity and Cardinality} % 等势与基数
    ...
    denoted by \(A \sim B\), if there exists a bijection \(f : A \to B\).
    
    The \textbf{cardinality} of a set \(A\) is the least ordinal \(\kappa\) such that \(A \sim \kappa\),
    denoted by \(|A|\) (or \(\mathrm{card}(A)\), \(\overline{\overline{A}}\)).
\end{definition}
